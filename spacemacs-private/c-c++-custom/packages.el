...
(unless (version< emacs-version "24.4")
  (add-to-list 'c-c++-custom-packages 'srefactor))

(defun c-c++-custom/init-cc-mode ()
  (use-package cc-mode
    :defer t
    :init
...
(defun c-c++-custom/init-disaster ()
...
(defun c-c++-custom/init-clang-format ()
  (use-package clang-format
    :if c-c++-enable-clang-support))

(defun c-c++-custom/init-cmake-mode ()
...
(defun c-c++-custom/post-init-company ()
...
(when (configuration-layer/layer-usedp 'auto-completion)
  (defun c-c++-custom/init-company-c-headers ()
...
(defun c-c++-custom/post-init-semantic ()
  (semantic/enable-semantic-mode 'c-mode)
  (semantic/enable-semantic-mode 'c++-mode))

(defun c-c++-custom/post-init-srefactor ()
...
(defun c-c++-custom/pre-init-helm-cscope ()
  (spacemacs|use-package-add-hook xcscope
    :post-init
    (dolist (mode '(c-mode c++-mode))
