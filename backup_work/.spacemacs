...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ox-reveal zeal-at-point xterm-color ws-butler wolfram-mode window-numbering web-mode wakatime-mode volatile-highlights vi-tilde-fringe toc-org tagedit stickyfunc-enhance stan-mode srefactor spaceline powerline smooth-scrolling smeargle slim-mode shell-pop scss-mode scad-mode sass-mode restart-emacs rainbow-mode rainbow-identifiers rainbow-delimiters qml-mode popwin persp-mode pcre2el paradox hydra spinner pangu-spacing page-break-lines orgit org-repo-todo org-present org-pomodoro alert log4e gntp org-plus-contrib org-bullets open-junk-file neotree multi-term move-text mmm-mode matlab-mode markdown-toc markdown-mode magit-gitflow macrostep lua-mode lorem-ipsum linum-relative leuven-theme less-css-mode julia-mode jade-mode info+ indent-guide ido-vertical-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation help-fns+ helm-themes helm-swoop helm-projectile helm-mode-manager helm-make projectile pkg-info epl helm-gtags helm-gitignore helm-flyspell helm-flx helm-descbinds helm-dash helm-css-scss helm-company helm-c-yasnippet helm-ag haml-mode google-translate golden-ratio gnuplot gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger gh-md ggtags flx-ido flx find-by-pinyin-dired fill-column-indicator fcitx fancy-battery expand-region exec-path-from-shell evil-visualstar evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit magit magit-popup git-commit with-editor evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-args evil-anzu anzu eval-sexp-fu highlight eshell-prompt-extras esh-help emmet-mode elisp-slime-nav disaster define-word company-ycmd f ycmd request-deferred request deferred s company-web web-completion-data company-statistics company-quickhelp company-c-headers company-auctex company cmake-mode clean-aindent-mode clang-format chinese-pyim chinese-pyim-basedict pos-tip buffer-move bracketed-paste auto-yasnippet yasnippet auto-highlight-symbol auto-dictionary auto-compile packed dash auctex arduino-mode aggressive-indent adaptive-wrap ace-window ace-pinyin pinyinlib ace-jump-mode ace-link ace-jump-helm-line helm avy helm-core async ac-ispell auto-complete popup quelpa package-build use-package which-key bind-key bind-map evil spacemacs-theme)))
